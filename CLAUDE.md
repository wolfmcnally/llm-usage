...
second and polls `/data.json` every `HTML_POLL_SECONDS` (60); it applies the
same extra-limit visibility rule as the terminal renderers (below), follows
